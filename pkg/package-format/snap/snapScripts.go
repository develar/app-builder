...
func desktopScriptsDesktopCommonSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "desktop-scripts/desktop-common.sh", size: 16604, mode: os.FileMode(420), modTime: time.Unix(1721338611, 0)}
...
func desktopScriptsDesktopGnomeSpecificSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "desktop-scripts/desktop-gnome-specific.sh", size: 1401, mode: os.FileMode(420), modTime: time.Unix(1721338611, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func desktopScriptsDesktopInitSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "desktop-scripts/desktop-init.sh", size: 1530, mode: os.FileMode(420), modTime: time.Unix(1721338611, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
