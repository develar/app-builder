...
// Package package_format generated by go-bindata.
// sources:
...
func appimageTemplatesApprunSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "appimage/templates/AppRun.sh", size: 3815, mode: os.FileMode(493), modTime: time.Unix(1656859817, 0)}
